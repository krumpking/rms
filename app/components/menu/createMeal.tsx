		...
		if (files.length > 0) {
			...
			try {
				...
				try {
					...
					addDocument(MEAL_ITEM_COLLECTION, meal)
						.then((v) => {
							setLoading(false);
					...
					<div>
						{menuItems.length > 0 ? (
										...
										<div className='w-full'>
											{menuItems.length > 0 ? (
												...
												<h1 className='col-span-2'>
													Looks like you are yet to add Menu Items
												</h1>
											)}
										</div>
									</div>
							...
							<div className='flex items-center'>
								<h1>
									Looks like you are yet to add menu items, first add menu items
									to be able to add meals
								</h1>
							</div>
						)}
					</div>
