...
const Home: NextPage = () => {
  ...
  const [services, setServices] = useState<any[]>([
    {
      ...
      description: 'FoodiesBooth will help you have your own customizable website, with your own unique name, which would allow people to order from your website, place reservations, contact you directly'
    },
    {
      title: 'Order Management',
      description: 'FoodiesBooth will help you capture orders and their lifecycle to remove any bottle necks and ensure customers are fully satisfied'
    },
    {
      title: 'Menu Management',
      description: 'FoodiesBooth will help you easily create, edit and manage your Menu.From creating regular Menu, to creating promotions in a simple way'
    },

    {
      title: 'Cash Management',
      description: 'FoodiesBooth will help you easily record the transactions in your business.Understand your business like never before'
    },

    {
      title: 'Listing on our Market Place',
      description: 'FoodiesBooth will automatically list your Menu Items and Meals on our Market Place giving you incredible exposure to new customers'
    },
    {
      title: 'Shift Management',
      description: 'FoodiesBooth will help you arrange staff shift and produce a log book to make payroll very simple'
    },
    {
      title: 'Delivery Management',
      description: 'FoodiesBooth will handle all your deliveries and you can focus on what matters the most, making every bite memorable'
    },
    {
      title: 'Stock Management',
      description: 'FoodiesBooth will help you measure stock level, and be able to make data based decisions to ensure you continue to provide the best service to your customers'
    }
  ]);
  const [pricing, setPricing] = useState<any[]>([
    {
      ...
      feats: ['Editable Website', 'Order Management', 'Menu Management', 'Stock Management', 'Cash Management', 'Market Place Listing', 'Delivery Management', '1 User', '']
    },
    {
      title: TEAM_PACKAGE,
      pricing: TEAM_PACKAGE_PRICE,
      desc: 'For those who are growing and have a have a team',
      feats: ['Editable Website', 'Order Management', 'Menu Management', 'Stock Management', 'Cash Management', 'Market Place Listing', 'Delivery Management', '5 users', '']
    },
    {
      title: ENTERPRISE_PACKAGE,
      pricing: ENTERPRISE_PACKAGE_PRICE,
      desc: 'For businesses that have an entire team',
      feats: ['Editable Website', 'Order Management', 'Menu Management', 'Stock Management', 'Cash Management', 'Market Place Listing', 'Delivery Management', 'Shift Management', 'Unlimited Number of users']
    },
  ]);
  ...
  const [faqs, setFaqs] = useState<any[]>([
    {
      ...
      answer: 'FoodiesBooth Market Place is an online place to help you make orders to the best Food Businesses in the country at a click of a button'
    },
    {
      que: 'How does FoodiesBooth work?',
      answer: 'We serve the best Food Businesses in the country, helping take care of the operations so they can focus on making every bite memorable'
    },
    {
      que: 'Can I use FoodiesBooth for free?',
      answer: 'FoodiesBooth is a subscription service, but allows for 7 days FREE trial, to allow you to see how much it can change your Food Business'
    },
    {
      que: 'Is FoodiesBooth affiliated to the Food Businesses on the Market Place?',
      answer: 'FoodiesBooth helps Food Businesses but does not have any affiliation with any Food Business'
    },
    {
      que: 'Is the FoodiesBooth secure and protects my data?',
      answer: 'Foodies Booth data is encrypted and uses the best standards for protecting data and is not shared with anyone'
    },
    {
  ...
  const getMenuItems = () => {
    ...
    getDataFromAll(WEBSITE_INFO_COLLECTION).then((v) => {

      if (v !== null) {
        v.data.forEach(element => {
          let d = element.data();

          setBooths(meals => [...meals, {
            id: d.id,
    ...
    <div>
      {loading ? <div className='flex items-center content-center w-full h-screen justify-center p-16'>
        ...
        <div className='w-full h-full'>
          {isOtherWebsite ? <WebsiteHandler business={business} /> :
            <div className='relative  w-full h-full'>
              ...
              <div className='flex flex-col mb-6' id="booths">
                <h1 className='text-4xl text-center mb-12'>The Best Food Businesses in the country</h1>
                <div className='grid grid-cols-3 gap-8 p-8'>
                  {booths.slice(0, 3).map((v) => (
                    <div
                      className='relative shadow-2xl rounded-[25px] p-4 w-3/4'>
                      <div className='p-4'>
              ...
              <div className='flex flex-col justify-center items-center' id='services'>
                ...
                <p className='m-4'>We do all the dirty work and let you focus on making <span style={{ color: PRIMARY_COLOR }}>every bite memorable</span></p>
                <div className='grid grid-cols-2 gap-4 mb-6 p-8 place-items-center place-content-center'>
                  {services.map((v) => (
                    <div
                      className='relative shadow-2xl rounded-[25px] p-4 w-5/6 h-42'>
                      <div className='p-4'>
              ...
              <div className='flex flex-col justify-center items-center' id="pricing" >
                ...
                <div className='text-2xl'>
                  {enabled ? <div className='flex flex-row'>
                ...
                <div className="grid place-items-center">
                  <Switch
                    checked={enabled}
                    onChange={setEnabled}
                    style={{ backgroundColor: enabled ? PRIMARY_COLOR : FOURTH_COLOR }}
                    className={`$
                ...
                <div className='grid grid-cols-3 gap-4'>
                  {pricing.map((v) => (
                    <div className='shadow-xl w-full flex flex-col p-4 rounded-[25px]'>
                      ...
                      <p>{v.desc}</p>
                      <h1 className='text-2xl'>{enabled ? v.pricing * 11 : v.pricing}USD</h1>
              ...
              <div className='grid grid-cols-2 p-8'>
                ...
                <div>
                  {faqs.map((v) => (
                    <Disclosure >
                      <Disclosure.Button className={'w-full flex flex-row space-x-4 items-start shadow-md p-4 rounded-[25px] content-center'}>
                      ...
                      <Disclosure.Panel className={'w-full flex flex-row space-x-4 items-start shadow-md p-4 rounded-[25px]'}>
                        {v.answer}
                      </Disclosure.Panel>
                    </Disclosure>
                  ))}
              ...
              <div style={{ backgroundColor: PRIMARY_COLOR }} className='h-48 grid grid-cols-3 gap-4 place-items-center'>
                <div>
                  <a><p className='text-white underline'>Terms and Conditions</p></a>
