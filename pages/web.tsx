...
const WebFront = () => {
    ...
    const getSelectedWebsite = () => {
        getOneDocument(WEBSITE_COLLECTION, adminId).then((v) => {
    ...
    const addWebsite = async () => {
        setOpen(false);
        setLoading(true);
        addDocument(WEBSITE_COLLECTION, chooseWebsite).then((v) => {
    ...
    const editWebsite = async () => {
        ...
        setOpen(false);
        setLoading(true);
        updateDocument(WEBSITE_COLLECTION, chooseWebsite.id, newItem).then((v) => {
