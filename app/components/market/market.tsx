                ...
                <div className="bg-white rounded-[30px] p-4 ">
                            ...
                            <div className='flex flex-row-reverse space-x-4'>
                                ...
                                >
                                    ...
                                    <span className="absolute inset-0 object-right-top -mr-12">
                                        <div className={"inline-flex items-center px-1.5 py-0.5 border-2 border-white rounded-full text-xs font-semibold leading-4 text-white"} style={{ backgroundColor: PRIMARY_COLOR }} >
                                            {addItems.length}
                                        </div>
                                    </span>
                                </button>
                    ...
                    <Drawer isOpen={isOpen} setIsOpen={setIsOpen} bg={"#fff"} color={PRIMARY_COLOR}>
                        <div style={{ borderColor: PRIMARY_COLOR }} className="border rounded-[25px] h-fit w-full flex flex-col items-center m-4 p-4">
                            ...
                            {order.deliveryMethod == "Delivery" ? <div className='flex flex-row items-center text-center px-8 py-4 my-2 shadow-xl rounded-[25px] w-full'>
                                {loadDist ?
