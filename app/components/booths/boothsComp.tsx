...
import { DEFAULT_LOCATION, WEBSITE_INFO_COLLECTION } from '../../constants/websiteConstants';
                    ...
                    <div className='border rounded-[25px] w-full h-full' style={{ borderColor: PRIMARY_COLOR }}>
                        ...
                        <div className='p-8'>
                            ...
                            <div className='grid grid-cols-3 gap-8 p-8'>
                                {booths.map((v) => (
                                    <div
                                        className='relative shadow-2xl rounded-[25px] p-4 w-full'>
                                        <div className='p-4'>
                                            ...
                                            <div className='flex justify-between'>
                                                ...
                                                <div className='flex flex-row space-x-2'>
                                                    ...
                                                    <button
                                                        onClick={() => { router.push(`${v.websiteName}.${PRIMARY_URL_LOCAL}`) }}
                                                        className='relative rounded-full p-2'
                                                        style={{ backgroundColor: PRIMARY_COLOR }} >
                                                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" className="w-6 h-6 text-white">
