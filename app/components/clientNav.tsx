						...
						<div className='flex flex-col space-y-4 z-20'>
							...
							>
								<div className='grid grid-cols-4 w-full '>
									<svg
										...
										stroke-width='1.5'
										stroke='currentColor'
										className='w-6 h-6 col-span-1 text-white justify-self-center'
									>
										<path
											stroke-linecap='round'
											stroke-linejoin='round'
							...
							>
								<div className='grid grid-cols-4 w-full'>
									...
									<h1 className='col-span-3 text-white'>Market Place</h1>
								</div>
							</a>
							...
							>
								<div className='grid grid-cols-4 w-full'>
									...
									<h1 className='col-span-3 text-white'>My Orders</h1>
								</div>
							</a>
							<a
								href={'/myrewards'}
							...
							>
								<div className='grid grid-cols-4 w-full'>
									...
									<h1 className='col-span-3 text-white'>My Rewards</h1>
								</div>
							</a>
							...
							<a
								...
								className={'p-2 rounded-[25px] hover:cursor-pointer'}
							>
								<div className='grid grid-cols-4 w-full'>
									<svg
										xmlns='http://www.w3.org/2000/svg'
						...
						<div className='flex flex-col space-y-4 z-20'>
							...
							>
								<div className='grid grid-cols-4 w-full'>
									...
									<h1 className='col-span-3 text-white'>Customer Rewards</h1>
								</div>
							</a>
							<a
								href={'/cashbook'}
