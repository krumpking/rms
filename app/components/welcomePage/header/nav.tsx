                    ...
                    <div className="flex items-center justify-between p-4 content-center">
                        ...
                        <div className="flex items-baseline flex-row justify-end space-x-4 ">
                            {navItems.map((v, index) => {
                                return (<div className={`bg-white rounded-[25px] p-2`} key={index}>
                                    <a className={'md:text-xs 2xl:text-xl text-center  p-1 lg:p-4'} style={{ color: PRIMARY_COLOR }} href={v.url} >{v.name}</a>
                                </div>)
