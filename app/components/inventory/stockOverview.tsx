					...
					v.data.forEach((element) => {
						...
						for (let i = 0; i < display.length; i++) {
							if (display[i].details === v.details) {
								count =
									parseInt(display[i].itemNumber) + parseInt(v.itemNumber);
								index = i;
								break;
							}
						}
				...
				<div className='bg-white rounded-[30px] p-4 '>
					{loading ? (
						...
						<div className='flex flex-col overflow-y-scroll max-h-[700px] w-full gap-4 p-4'>
							<div className='grid grid-cols-1 lg:grid-cols-5 shadow-lg p-8 rounded-[25px]'>
								<div className='flex flex-col items-center border-r-0 md:border-r-2'>
