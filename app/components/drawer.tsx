...
const Drawer: FC<MyProps> = ({ children, isOpen, setIsOpen, bg, color }) => {
    return (
        ...
        >
            ...
            >
                <article style={{ backgroundColor: bg }} className={" relative w-screen max-w-lg pb-10 flex flex-col space-y-6 overflow-y-scroll h-full  rounded-[30px] items-center shadow-md px-8"}>
                    <button onClick={() => setIsOpen(false)}>
                        <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="currentColor" style={{ color: color }} className="w-6 h-6 m-2">
